...
export class Backend implements backendInterface {
    ...
    async getHolderAddress(arg0: Principal): Promise<HolderInfo> {
    ...
    async getUniqueHolderAddresses(): Promise<Array<HolderInfo>> {
        if (this.processError) {
            try {
                const result = await this.actor.getUniqueHolderAddresses();
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async swapTokens(arg0: AssetSymbol, arg1: AssetSymbol, arg2: bigint): Promise<PriceResultNat> {
        if (this.processError) {
            try {
    ...
    async validateAddress(arg0: Uint8Array): Promise<boolean> {
        if (this.processError) {
            try {
                const result = await this.actor.validateAddress(arg0);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_PriceResultNat_n1(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _PriceResultNat): PriceResultNat {
